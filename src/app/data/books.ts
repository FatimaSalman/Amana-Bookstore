...
export const books: Book[] = [
  ...
  {
    id: '46',
    title: 'Android Development toturial',
    author: 'Eng. Fatima M. Salman',
    description: 'This tutorial has been prepared for beginners to help them understand basic Android programming.',
    price: 10.95,
    image: '/images/book3.jpg',
    isbn: '978-4567890123',
    genre: ['Computer Science','Development Application'],
    tags: ['Android', 'SDK', 'Java', 'Kotlin'],
    datePublished: '2023-08-20',
    pages: 892,
    language: 'English',
    publisher: 'Al-Kindi Quantum Institute',
